...
import { ChatSidebar } from "./_components/sidebar/ChatSidebar";
import { ChatWindow } from "./_components/chat-window/ChatWindow";
import { DeleteConfirmDialog } from "./_components/shared/DeleteConfirmDialog";
...
export default function ChatPage() {
  ...
  return (
    <div className="flex bg-slate-100 dark:bg-slate-950 flex-col md:flex-row h-screen overflow-hidden">
      <div className={`${chat.activeChat ? 'hidden md:flex' : 'flex'} w-full md:w-auto h-full`}>
        <ChatSidebar 
      ...
      <div className={`${chat.activeChat ? 'flex' : 'hidden md:flex'} flex-1 h-full flex-col`}>
        <ChatWindow 
          activeChat={chat.activeChat}
