      ...
      <div className="flex flex-col space-y-5 pb-6">
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center min-h-[400px] text-slate-400 group/empty">
            ...
            <p className="font-medium text-lg text-slate-500 dark:text-slate-400">Suasana sangat sepi...</p>
            <p className="text-sm text-slate-400 mt-1">Sapa {activeChat} sekarang juga!</p>
          </div>
        )}
